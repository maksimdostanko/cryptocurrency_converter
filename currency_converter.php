...
function getRate()
{
	...
	$currencyServerData->setCacheTime($cacheTime);
...
{
	// JS
//	wp_register_script('prefix_jquery-3.3.1.slim.min.js', 'https://code.jquery.com/jquery-3.3.1.slim.min.js');
//	wp_enqueue_script('prefix_jquery-3.3.1.slim.min.js');
    wp_enqueue_script('jquery');

	wp_register_script('currency_converter_popper', 'https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.0/umd/popper.min.js');
	wp_enqueue_script('currency_converter_bpopper');
